...
public class DateValidator {
     ...
     */
    public static final int MAXIMUM_VALID_YEAR_DIFFERENCE = 40;
    ...
    /**
     * Used in tests to inject a custom {@link java.util.Calendar} to stabilize dates. Normal usage will just
